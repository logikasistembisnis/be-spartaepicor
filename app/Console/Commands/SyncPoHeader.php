...
class SyncPoHeader extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sync:epicor-poheader {arg1? : Periode Awal (ym) atau StartDate (Ymd)} 
    ...
    public function handle()
    {
        ...
        if ($this->option('all')) {
            ...
            $this->info('Memulai sinkronisasi SEMUA data PoHeader dari Epicor');

            // Panggil controller dengan null, null
            $result = $controller->syncPoHeaderData(null, null);
        ...
        if ($endPeriod) {
            ...
            while ($current <= $end) {
                ...
                $result = $controller->syncPoHeaderData($periodString, $startDate);
