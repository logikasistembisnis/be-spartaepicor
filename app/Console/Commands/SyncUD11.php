...
class SyncUD11 extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sync:epicor-ud11 {arg1? : Periode Awal (ym) atau StartDate (Ymd)} 
    ...
    public function handle()
    {
        ...
        if ($this->option('all')) {
            ...
            $this->info('Memulai sinkronisasi SEMUA data UD11 dari Epicor');

            // Panggil controller dengan null, null
            $result = $controller->syncUD11Data(null, null);
        ...
        if ($endPeriod) {
            ...
            while ($current <= $end) {
                ...
                $result = $controller->syncUD11Data($periodString, $startDate);
