...
class SyncRcvDtl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sync:epicor-rcvdtl {arg1? : Periode Awal (ym) atau StartDate (Ymd)} 
    ...
    public function handle()
    {
        ...
        if ($this->option('all')) {
            ...
            $this->info('Memulai sinkronisasi SEMUA data RcvDtl dari Epicor');

            // Panggil controller dengan null, null
            $result = $controller->syncRcvDtlData(null, null);
        ...
        if ($endPeriod) {
            ...
            while ($current <= $end) {
                ...
                $result = $controller->syncRcvDtlData($periodString, $startDate);
