...
use App\Http\Controllers\UD03Controller;
use Illuminate\Support\Facades\Log;

class SyncUD03 extends Command
{
    /**
     * Nama perintah (command)
     * @var string
     */
    protected $signature = 'sync:epicor-ud03 {arg1? : Periode Awal (ym) atau StartDate (Ymd)} 
     ...
     * @var string
     */
    protected $description = 'Mengambil data UD03 dari Epicor API dan menyinkronkannya (UPSERT).';
    ...
    public function handle()
    {
        ...
        if ($this->option('all')) {
            ...
            $this->info('Memulai sinkronisasi SEMUA data UD03 dari Epicor');

            // Panggil controller dengan null, null
            $result = $controller->syncUD03Data(null, null);
        ...
        if ($endPeriod) {
            ...
            while ($current <= $end) {
                ...
                $result = $controller->syncUD03Data($periodString, $startDate);
        ...
        // --- SCENARIO 1: TUNGGAL (atau DEFAULT) ---
            ...
            if ($hasArgs) {
                 $this->info('Memulai sinkronisasi data UD03 dari Epicor');
            } else {
            ...
            // Panggil controller
            $result = $controller->syncUD03Data($period, $startDate); 
