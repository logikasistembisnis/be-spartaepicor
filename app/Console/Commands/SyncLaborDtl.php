...
class SyncLaborDtl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sync:epicor-labordtl {arg1? : Periode Awal (ym) atau StartDate (Ymd)} 
    ...
    public function handle()
    {
        ...
        if ($this->option('all')) {
            ...
            $this->info('Memulai sinkronisasi SEMUA data LaborDtl dari Epicor');

            // Panggil controller dengan null, null
            $result = $controller->syncLaborDtlData(null, null);
        ...
        if ($endPeriod) {
            ...
            while ($current <= $end) {
                ...
                $result = $controller->syncLaborDtlData($periodString, $startDate);
