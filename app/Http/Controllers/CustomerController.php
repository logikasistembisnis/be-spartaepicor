...
class CustomerController extends Controller
{
     ...
     */
    public function syncCustomerData(?string $period = null, ?string $startDate = null): array
    {
        ...
        do {
            ...
            ->timeout(600)
            ->get(env('EPICOR_API_URL'). '/ETL_Customer/Data', $apiParams);
